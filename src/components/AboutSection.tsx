    ...
    <section id="about" className="py-20 px-4 bg-gradient-to-b from-background to-muted/30">
      <div className="container max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-heading mb-6 bg-gradient-to-r from-gray-700 to-primary bg-clip-text text-transparent">
        ...
        <div className="mt-16 bg-gradient-to-r from-primary/5 to-blue-600/5 rounded-3xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center group">
              <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary to-emerald-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-200">
                200+
              </div>
